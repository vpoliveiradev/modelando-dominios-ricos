    ...
    public abstract class Payment : Entity
    {
        protected Payment(DateTime paidDate, DateTime expireDate, decimal total, decimal totalPaid, string payer, Document document, Address address, Email email)
        {
            ...
            AddNotifications(new Contract<Payment>()
                ...
                .IsNotNullOrEmpty(Payer, "Payment.Payer", "O pagador deve ser informado.")
                .IsNotNull(Document, "Payment.Document", "O documento deve ser informado.")
                .IsNotNull(Address, "Payment.Address", "O endereço deve ser informado.")
                .IsNotNull(Email, "Payment.Email", "O e-mail deve ser informado.")
            );
        }
